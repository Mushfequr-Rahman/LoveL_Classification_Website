      ...
      <div class="question-box column is-half">
        <article class="message is-pink">
          ...
          <div class="message-body">
            ...
            <div class="board-item">
              <div @click="loveOptionClick(1)" v-if="QuestionLen" class="board-item-content">
                <span>{{ this.questions[this.index].op2 }}</span>
              </div>
            </div>
          </div>
        </article>
...
var RadarChart = {
  ...
  draw: function(id, d, options) {
    ...
    d3.select(id)
      ...
      var data = [{
        className: 'Result', // optional can be used for styling
        // "1": "Words of Affirmation",
      //   "2": "Act of Service",
      //   "3": "Receiving Gift",
      //   "4": "Quality Time",
      //   "5": "PhysicalTouch"
        axes: [{
            axis: 'Words of Affirmation',
            value: this.score[1]
        }, {
            axis: 'Act of Service',
            value: this.score[2]
        }, {
            axis: 'Receiving Gifts',
            value: this.score[3]
        }, {
            axis: 'Quality Time',
            value: this.score[4]
...
/* Refered from: https://rawgit.com/tpreusse/radar-chart-d3/master/src/radar-chart.css */
.area.Result,
.Result .circle {
  fill: #8142f5;
  stroke: none;
